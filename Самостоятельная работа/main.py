...
def get_token_id(file_name):
    """Используется для чтения токена и ID пользователя из файла - построчно"""
...
def find_max_dpi(dict_in_search):
    """Возвращает ссылку на фото max размера и размер фото"""
    max_dpi = 0
    need_elem = 0
...
def time_convert(time_unix):
    """Преобразует дату загрузки фото в привычный формат"""
...
class VkRequest:
    def __init__(self, token_list, version='5.131'):
        """Использую данный метод для получения начальных основных параметров запроса для VK"""
    ...
    def _get_photo_info(self):
        """Использую данный метод для получения количества фотографий и массива фотографий"""
    ...
    def _get_logs_only(self):
        """Использую данный метод для получения словаря с параметрами фотографий"""
    ...
    def _sort_info(self):
        """Использую данный метод для получения словаря с параметрами фотографий и списка JSON для выгрузки"""
        json_list = []
        sorted_dict = {}
...
class Yandex:
    def __init__(self, folder_name, token_list, num=5):
        """Использую данный метод для получения основных параметров для загрузки фотографий на Y-диск"""
        self.token = token_list[0]
    ...
    def _create_folder(self, folder_name):
        """Использую данный метод для создания папки на Y-диске для загрузки фотографий"""
    ...
    def _in_folder(self, folder_name):
        """Использую данный метод для получения ссылки для загрузки фотографий на Y-диск"""
        url = "https://cloud-api.yandex.net/v1/disk/resources"
        params = {'path': folder_name}
    ...
    def create_copy(self, dict_files):
        """Использую данный метод загрузки фотографий на Y-диск"""
...
if __name__ == '__main__':
    tokenVK = 'VK_TOKEN_my.txt'
    tokenYandex = 'Ya_TOKEN_my.txt'
